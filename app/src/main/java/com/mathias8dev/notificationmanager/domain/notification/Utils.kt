...
fun Context.notify(
    ...
    val notificationBuilder = if (notificationData is NotificationDataRes)
        notificationData.toNotification(this, channelId)
    else (notificationData as NotificationDataRaw).toNotification(this, channelId)
...
fun Context.notify(
    ...
    val notification = notificationData.toNotification(this, channelId)
        .apply {
            groupKey?.let { this.setGroup(it) }
            onAddMoreCustomization?.invoke(this)
        }
...
internal fun NotificationDataRes.toNotification(
    context: Context,
    channelId: String
...
internal fun NotificationDataRaw.toNotification(
    context: Context,
    channelId: String
): NotificationCompat.Builder {
    return NotificationCompat.Builder(context, channelId)
